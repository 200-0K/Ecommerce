...
return [
    ...
    */
    ...
    'alpha_dash' => 'يجب أن يحتوي الحقل :attribute فقط على حروف، أرقام، شرطات أو شرطات سفلية.',
    ...
    'doesnt_start_with' => 'يجب على الـ :attribute الا يبدأ بأحد القيم التالية: :values.',
    ...
    'max' => [
        ...
        'file' => 'يجب أن لا يتجاوز حجم الملف :attribute عن :max كيلوبايت.',
        'numeric' => 'يجب أن تكون قيمة الحقل :attribute مساوية أو أصغر لـ :max.',
        'string' => 'يجب أن لا يتجاوز طول نص :attribute عن :max حروفٍ/حرفًا.',
    ],
    'max_digits' => 'الـ :attribute يجب ان يكون اقل من :max أرقام.',
    ...
    'min_digits' => 'الـ :attribute يجب ان يكون على الأقل من :min أرقام.',
    'multiple_of' => 'الـ :attribute يجب ان يكون من مضاعفات الـ :value.',
    ...
    'required_if_accepted' => 'الحقل :attribute مطلوب في حال قبول الحقل :other.',
