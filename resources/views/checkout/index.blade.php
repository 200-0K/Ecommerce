      ...
      <div class="relative">
        <ul class="relative flex w-full items-center justify-between gap-4 space-x-2 sm:space-x-4">
          <li class="flex items-center gap-3 text-left">
            <a class="flex h-6 w-6 items-center justify-center rounded-full bg-emerald-200 text-xs font-semibold text-emerald-700" href="#"><svg xmlns="http://www.w3.org/2000/svg" class="group- h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
          ...
          <li class="flex items-center gap-3 text-left">
            ...
            <span class="font-semibold text-gray-900">{{ __('app.shipping') }}</span>
          </li>
          <svg xmlns="http://www.w3.org/2000/svg" class="rtl:-scale-100 h-4 w-4 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            <path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7" />
          </svg>
          <li class="flex items-center gap-3 text-left">
            ...
            <span class="font-semibold text-gray-500">{{ __('app.payment') }}</span>
          </li>
        </ul>
      </div>
    </div>
    ...
    <div class="mt-10 bg-gray-50 px-4 pt-8 lg:mt-0">
      ...
      <form action="{{route('checkout')}}" method="POST">
        ...
        <div class="flex flex-col sm:flex-row">
          <select type="text" name="billing-state" class="text-center w-full rounded-md border border-gray-200 px-4 py-3 text-sm shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500">
            <option value="الرياض">الرياض</option>
            <option value="جده">جده</option>
            <option value="المدينه المنوره">المدينه المنوره</option>
            ...
            <option value="وادى الدواسر">وادى الدواسر</option>
            <option value="بيشه">بيشه</option>
            <option value="سيهات">سيهات</option>
            <option value="شروره">شروره</option>
            <option value="بحره">بحره</option>
            ...
            <option value="الحوطه">الحوطه</option>
            <option value="الافلاج">الافلاج</option>
          </select>

          <div class="relative flex-shrink-0 sm:w-7/12">
            <input type="text" id="billing-address" name="billing-address" class="w-full rounded-md border border-gray-200 px-4 py-3 pl-11 text-sm shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500" placeholder="{{ __('validation.attributes.address') }}" required />
            <div class="pointer-events-none absolute inset-y-0 left-0 inline-flex items-center px-3">
              <img class="h-4 w-4 object-contain" src="https://flagpack.xyz/_nuxt/504692f0f09c3fe396344ee04ac8ace9.svg" alt="Saudi Arabia Flag" />
            </div>
          </div>

          <input type="text" name="billing-zip" class="flex-shrink-0 rounded-md border border-gray-200 px-4 py-3 text-sm shadow-sm outline-none sm:w-1/6 focus:z-10 focus:border-blue-500 focus:ring-blue-500" placeholder="{{ __('validation.attributes.zip') }}" required />
        </div>
