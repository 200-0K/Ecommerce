  ...
  <div class="flex-none">
    ...
    <div class="dropdown dropdown-end">
      ...
      <div tabindex="0" class="mt-3 card card-compact dropdown-content w-52 bg-base-200 shadow">
        <div class="card-body">
          {{-- <span class="font-bold text-lg">{{ Auth::user()->cart->count() ?? '' }}</span> --}}
          <span class="text-info" dir="auto">{{ Auth::user()->cart->sum(fn ($product) => $product->new_price ?? $product->price ) ?? '' }} ريال</span>
