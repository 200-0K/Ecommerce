        ...
        <table class="min-w-full border-collapse border-spacing-y-2 border-spacing-x-2">
          <thead class="hidden border-b lg:table-header-group">
            <tr>
              ...
              <td class="whitespace-normal py-4 text-sm font-medium text-gray-500 sm:px-3">{{ __('app.product_name') }}</td>
          ...
          <tbody class="bg-white lg:border-gray-300">
            ...
            <tr class="rtl:text-right">
              <td class="whitespace-no-wrap py-4 text-left text-sm text-gray-600 sm:px-3 lg:text-left rtl:text-right">
                ...
                <div class="mt-1 flex flex-col text-xs font-medium lg:hidden">
                  ...
                  <a href="{{route('product.show', $order->product)}}">
                    <div class="flex items-center">
                      <svg xmlns="http://www.w3.org/2000/svg" class="mr-1 h-3 w-3" height="48" width="48" viewBox="0 0 48 48">
              ...
              <td class="whitespace-no-wrap hidden py-4 text-sm font-normal text-gray-600 sm:px-3 lg:table-cell"><a href="{{route('product.show', $order->product)}}">{{ $order->product->name }}</a></td>
              ...
              <td class="whitespace-no-wrap hidden py-4 text-left text-sm text-gray-600 sm:px-3 lg:table-cell lg:text-left rtl:text-right">{{ $order->user->name }}</td>
